...
author = "Trent Huhn"               # Name automatically put in the code templates.
...
last_advent_of_code_day = 13        # If the year isn't finished, the setup will download days up until that day included for the last year
# Imports
import os
import datetime
try:
